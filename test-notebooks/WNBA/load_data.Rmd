...
playerbox <- playerboxscore(
    "~/Dropbox/17-wnba-player/wnba-season-player-feed-07-02-2017.xlsx"
)
gamebox <- gameboxscore(playerbox)
salaries <- read_csv(
  "/home/Projects/draftkings/contest-standings/wnba/20170705/FanDuel-WNBA-2017-07-05-19959-players-list.csv",
  col_types = cols(
    X14 = col_skip(),
    X15 = col_skip()
  )
