...
playerbox <- playerboxscore(
    "~/Dropbox/17-wnba-player/wnba-season-player-feed-07-20-2017.xlsx"
)
gamebox <- gameboxscore(playerbox)
salaries <- read_csv(
  "/home/Projects/draftkings/contest-standings/wnba/20170725/FanDuel-WNBA-2017-07-25-20143-players-list.csv",
  col_types = cols(
    X14 = col_skip(),
    X15 = col_skip()
  )
...
dk_salaries <- read_csv(
  "/home/Projects/draftkings/contest-standings/nba/20170725/DKSalaries.csv") %>%
