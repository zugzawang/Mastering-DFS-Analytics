...
playerbox <- playerboxscore(
    "~/Dropbox/17-wnba-player/wnba-season-player-feed-07-05-2017.xlsx"
)
gamebox <- gameboxscore(playerbox)
salaries <- read_csv(
  "/home/Projects/draftkings/contest-standings/wnba/20170707/FanDuel-WNBA-2017-07-07-20000-players-list.csv",
  col_types = cols(
    X14 = col_skip(),
    X15 = col_skip()
  )
